...
class MultipleBarChartViewController: DemoBaseViewController {
    ...
    override func viewDidLoad() {
        ...
        let marker = EAPBalloonMarker(color: UIColor(white: 180/255, alpha: 1), font: .systemFont(ofSize: 12), textColor: .white, insets: UIEdgeInsets(top: 8, left: 8, bottom: 20, right: 8))
